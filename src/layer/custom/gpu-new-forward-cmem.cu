#include "gpu-new-forward-cmem.h"
#include <cmath>
#include <iostream>
...
void GPUInterfaceCMEM::conv_forward_gpu_prolog(
...
void GPUInterfaceCMEM::conv_forward_gpu(float *d_output, const float *d_input,
                                    const float *d_weight, const int n_sample,
                                    const int channel_out, const int channel_in,
                                    const int height_in, const int width_in,
                                    const int height_kernel) {
...
void GPUInterfaceCMEM::conv_forward_gpu_epilog(
